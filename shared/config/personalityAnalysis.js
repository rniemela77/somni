...
export const REVELATION_MILESTONES = [
  {
    key: 'theFlame',
    slug: 'the-flame',
...
export const CATEGORIES = {
  originRealm: {
    id: "originRealm",
    description: "The dawn of your myth, where primal essence takes shape."
  },
  outerRealm: {
    id: "outerRealm",
    description: "The waves you cast, shaping the world’s view of your story."
  },
  innerRealm: {
    id: "innerRealm",
    description: "The core of your being, where truth and desire forge your essence."
  },
  cosmicPath: {
    id: "cosmicPath",
    description: "The cosmic forces aligning your spirit with the universe’s rhythm."
  },
  destinyRealm: {
    id: "destinyRealm",
    description: "The path where traits converge, guiding you to your purpose."
  },
  narrative: {
    id: "narrative",
    description: "Your life’s story, woven through instinct and choice."
  }
};
