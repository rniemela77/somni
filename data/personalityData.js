const personalityData = [
  ...
  },
  {
    ...
    questions: [
      {
        id: 1,
        statementA: "I tend to speak first to share my ideas and direction",
        statementB: "I prefer to listen first and understand others before contributing",
        points: 1,
      },
      {
        id: 2,
        statementA: "I feel energized when others notice the quality of what I’ve done",
        statementB: "I feel satisfied as long as the work is done well, even if unnoticed",
        points: 1,
      },
      {
        id: 3,
        statementA: "If a group succeeds, I naturally highlight the parts I handled",
        statementB: "If a group succeeds, I emphasize the team's effort as a whole",
        points: 1,
      },
      {
        id: 4,
        statementA: "I tend to take on leadership roles because I trust my judgment",
        statementB: "I tend to share leadership and seek consensus before deciding",
        points: 1,
      },
      {
        id: 5,
        statementA: "I like being acknowledged when I go above and beyond",
        statementB: "I don't mind if extra effort goes unnoticed — the goal is what matters",
        points: 1,
      },
    ],
  },
